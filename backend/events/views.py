...
class EventViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Event.objects.filter(user=self.request.user).select_related(
...
class TriggerEventView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response(
                {'detail': f'Event "{event_slug}" not found or inactive.'},
        ...
        return Response(
            {'detail': 'Email queued for sending.', 'task_id': str(task.id)},
